...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/common/css/member_password_change.css?ver=<fmt:formatDate value="${today}" pattern="yyyyMMddHHmmss" />">
