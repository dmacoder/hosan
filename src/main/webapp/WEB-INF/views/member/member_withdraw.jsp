...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/common/css/member_withdraw.css?ver=<fmt:formatDate value="${today}" pattern="yyyyMMddHHmmss" />">
