...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/common/css/member_withdraw_confirm_password.css?ver=<fmt:formatDate value="${today}" pattern="yyyyMMddHHmmss" />">
